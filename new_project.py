...
#　辺を設定する．
G = nx.read_weighted_edgelist("Project_Code\dijkstra.txt",create_using=nx.DiGraph)     #有向グラフ
G1 = nx.read_weighted_edgelist("Project_Code\dijkstra.txt",create_using=nx.Graph)      #無向グラフ
